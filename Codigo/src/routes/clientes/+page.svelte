		...
		<form method="POST" action="?/update">
			<div class="flex flex-col gap-3 mt-3">
				<label class="input input-bordered flex items-center gap-2">
					...
					<input type="text" class="grow" placeholder="Name" name="name" value={selectedCliente.name}/>
				</label>
				<label class="input input-bordered flex items-center gap-2">
					<input type="text" class="grow" placeholder="Cnpj" name="cnpj" value={selectedCliente.cnpj} />
				</label>
